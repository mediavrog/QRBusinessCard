...
import net.mediavrog.qr_code_business_card.util.SystemUiHider;
...
public class CardActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    private static final int SETUP_CODE = 1001;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VCard card = VCardStorage.getVCard(this, "main");
        Picasso.with(this).load(new File(getCacheDir(), "main.png")).into((ImageView) findViewById(R.id.qrcode));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case SETUP_CODE:
                    //refreshView();
                    Toast.makeText(this, "Update vcard", Toast.LENGTH_SHORT);
                    break;
            }
        } else {
